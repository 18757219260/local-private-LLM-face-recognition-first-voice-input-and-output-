...
class KnowledgeQA:
    ...
    def ask(self, question: str) -> str:
        ...
        knowledge_gailema = os.path.getmtime(self.knowledge_path)
        if hasattr(self, "last_knowledge_update") and self.last_knowledge_update != knowledge_gailema:
            logging.info("知识库有更新，正在重新加载...")
            self.update_knowledge()
            self.last_knowledge_update = knowledge_gailema  
        query = f"问题: {question}\n\n{prompt}"
